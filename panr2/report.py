...
def write_report(output_dir, base_name, options=None, panr2_version="unknown", input_files=None):
    ...
    lines.append(
        ...
        "Static and interactive visualizations were generated from the same filtered data tables."
    )
    lines.append("")
